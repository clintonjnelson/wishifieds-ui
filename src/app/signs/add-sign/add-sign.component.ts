...
const CUSTOM_SIGNS: SignAddType[] = [
  ...
  { icon: 'deviantart',     bgColor: '#b3c432', signType: 'custom', signName: '' },
  { icon: 'disqus',         bgColor: '#2e9fff', signType: 'custom', signName: '' },
  { icon: 'etsy',           bgColor: '#d15600', signType: 'custom', signName: '' },
  { icon: 'facebook',       bgColor: '#3b5998', signType: 'custom', signName: '' },
  { icon: 'foursquare',     bgColor: '#f94877', signType: 'custom', signName: '' },
  { icon: 'instagram',      bgColor: '#675144', signType: 'custom', signName: '' },
  { icon: 'linkedin',       bgColor: '#4875B4', signType: 'custom', signName: '' },
  { icon: 'github',         bgColor: '#333333', signType: 'custom', signName: '' },
  { icon: 'twitter',        bgColor: '#00aced', signType: 'custom', signName: '' },
  { icon: 'google',         bgColor: '#dd4b39', signType: 'custom', signName: '' },
  { icon: 'pinterest',      bgColor: '#cb2027', signType: 'custom', signName: '' },
  { icon: 'reddit',         bgColor: '#FF5700', signType: 'custom', signName: '' },
  { icon: 'spotify',        bgColor: '#00e461', signType: 'custom', signName: '' },
  { icon: 'tumblr',         bgColor: '#35465c', signType: 'custom', signName: '' },
  { icon: 'vimeo',          bgColor: '#00bf8f', signType: 'custom', signName: '' },
  { icon: 'vk',             bgColor: '#45668e', signType: 'custom', signName: '' },
  { icon: 'wordpress',      bgColor: '#21759b', signType: 'custom', signName: '' },
  { icon: 'stack-overflow', bgColor: '#5184C1', signType: 'custom', signName: '' },
  { icon: 'youtube',        bgColor: '#bb0000', signType: 'custom', signName: '' },
  { icon: 'imgur',          bgColor: '#85bf25', signType: 'custom', signName: '' },
  { icon: 'patreon',        bgColor: '#e6461a', signType: 'custom', signName: '' },
];
